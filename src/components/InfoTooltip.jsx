    ...
    >
      <div className="popup__container popup__container_place_tooltip">
        <div className="tooltip">
          <img src={props.success ? acceptIcon : deniedIcon} alt={'Результат регистрации'} className="tooltip__icon" />
        ...
        <button className="popup__close page-button" type="button" onClick={props.onClose}></button>
      </div>
    </section>
  );
}
